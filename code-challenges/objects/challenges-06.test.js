...
const hasChildrenValues = (arr, character) => {
  // Solution code here...
  return Object.values(arr.filter(object=>object.name === character)[0])[2].length;
};
...
const hasChildrenEntries = (arr, character) => {
  // Solution code here...
  return arr.filter(object => object.name === character)[0].children.length;
};
...
const houseSize = (arr) => {
  ...
  arr.forEach(object => {
    ...
    sizes.push({house: object.house, members: number+object.children.length});
  });
  return sizes;
};
...
const houseSurvivors = (arr) => {
  ...
  arr.forEach(object => {
    ...
    if (object.spouse !== null && !deceasedSpouses.includes(object.spouse)) {
      number++;
    }
    survivors.push({house: object.house, members: number+object.children.length});
  });
  return survivors;
};
