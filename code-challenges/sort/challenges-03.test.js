...
const sortPeople = (arr) => {
  // Solution code here...
  return arr.sort((a, b) => a.lastName.localeCompare(b.lastName, 'en', { sensitivity: 'accent' }));
};
...
const sortPeopleBetter = (arr) => {
  // Solution code here...
  return arr.sort((a, b) => {
    if (a.lastName.localeCompare(b.lastName, 'en', { sensitivity: 'accent' }) === 0) {
      if (a.firstName.localeCompare(b.firstName, 'en', { sensitivity: 'accent' }) === 0) {
        return a.age - b.age;
      } else {
        return a.firstName.localeCompare(b.firstName, 'en', { sensitivity: 'accent' });
      }
    } else {
      return a.lastName.localeCompare(b.lastName, 'en', { sensitivity: 'accent' });
    }
  });
};
...
const sortMeetingsByDay = (arr) => {
  // Solution code here...
  Meeting.prototype.daySort = {'Monday': 1, 'Tuesday': 2, 'Wednesday': 3, 'Thursday': 4, 'Friday': 5};
  return arr.sort((a, b) => a.daySort[a.dayOfWeek] - b.daySort[b.dayOfWeek]);
};
...
const sortSchedule = (arr) => {
  // Solution code here...
  return arr.sort((a, b) => {
    if (a.daySort[a.dayOfWeek] - b.daySort[b.dayOfWeek] === 0) {
      return (parseInt(a.end) - parseInt(a.start)) - (parseInt(b.end) - parseInt(b.start));
    } else {
      return a.daySort[a.dayOfWeek] - b.daySort[b.dayOfWeek];
    }
  });
};
